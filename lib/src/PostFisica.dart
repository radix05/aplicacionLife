...
class PostFisica extends StatefulWidget {
  const PostFisica({Key? key}) : super(key: key);

  @override
  _PostFisica createState() => _PostFisica();
}

class _PostFisica extends State<PostFisica> {
