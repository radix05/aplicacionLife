      ...
      child: const Row(
        ...
        children: [
          Flexible(
            flex: 3,
            child: Text(
              'Al adoptar estos hábitos de sueño saludables, puedes contribuir a una mejor calidad de vida durante la menopausia, ayudando a reducir los trastornos del sueño y a promover un descanso reparador.',
              style: TextStyle(
                fontSize: 20.0,
                color: Colors.black,
              ),
