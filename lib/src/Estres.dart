...
class Estres extends StatefulWidget {
  const Estres({Key? key}) : super(key: key);

  @override
  _Estres createState() => _Estres();
}

class _Estres extends State<Estres> {
      ...
      child: const Row(
        ...
        children: [
          Flexible(
            flex: 3,
            child: Text(
              'El manejo del estrés es esencial, ya que los cambios emocionales y físicos que pueden aumentar la sensación de estrés.',
              style: TextStyle(
                fontSize: 20.0,
                color: Colors.black,
              ),
      ...
      child: const Row(
        ...
        children: [
          Flexible(
            flex: 3,
            child: Text(
              'Identificar las fuentes de estrés en tu vida y tomar medidas para evitarlas o reducirlas es fundamental. Esto podría incluir la carga de trabajo, establecer límites en las relaciones personales o eliminar actividades que te resulten abrumadoras..',
              style: TextStyle(
                fontSize: 20.0,
                color: Colors.black,
              ),
      ...
      child: const Row(
        ...
        children: [
          Flexible(
            flex: 3,
            child: Text(
              'Mantener un estilo de vida saludable es esencial para el manejo del estrés. Esto incluye una alimentación equilibrada, ejercicio regular y descanso adecuado.',
              style: TextStyle(
                fontSize: 20.0,
                color: Colors.black,
              ),
      ...
      child: const Row(
        ...
        children: [
          Flexible(
            flex: 3,
            child: Text(
              'El manejo del estrés es una parte importante del cuidado de tu bienestar físico y emocional. pero con las estrategias adecuadas, puedes minimizar su impacto en tu salud y calidad de vida. Si el estrés se vuelve abrumador, considera buscar apoyo profesional para ayudarte a afrontar los desafíos emocionales',
              style: TextStyle(
                fontSize: 20.0,
                color: Colors.black,
              ),
